...
class BrandHeader(Flowable):
    ...
    def draw(self):
        ...
        self.canv.drawRightString(self.width, self.height - 16, "www.clinicalperformancelab.com")
        # Thin underline
...
def draw_cover(canvas_obj, doc, volume):
    ...
    c.drawString(56, 52, "www.clinicalperformancelab.com")
...
def make_page_template(volume):
    ...
    def on_page(canvas_obj, doc):
        ...
        canvas_obj.drawString(0.6 * inch, 0.3 * inch, "www.clinicalperformancelab.com")
...
def build_volume_pdf(volume, meta):
    ...
    brand_strip = Paragraph(
        ...
        'www.clinicalperformancelab.com  ·  hello@clinicalperformancelab.com</font>',
        styles["body"]
    )
